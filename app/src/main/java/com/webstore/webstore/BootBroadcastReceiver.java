...
import com.vns.webstore.middleware.worker.WebstoreIntentService;
import com.vns.webstore.middleware.worker.WebstoreService;
...
public class BootBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(ACTION_USER_PRESENT)) {
            ...
            //Service
            if(!WebstoreService.isRunning) {
                Intent serviceIntent = new Intent(context, WebstoreService.class);
