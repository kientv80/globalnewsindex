...
import com.vns.webstore.middleware.service.AppConfig;
...
public class BaseActivity  extends AppCompatActivity {
    ...
    private static void initWebpages(){
        ...
        JsonArray categories = new JsonParser().parse(AppConfig.getConfig("categories")).getAsJsonArray();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new AppConfig().loadAppConfig();
        while(AppConfig.getConfig("config") == null){
            try {
                Thread.sleep(2000);
